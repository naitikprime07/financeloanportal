...
const Terms = () => {
  return (
    <>
      <Helmet>
        <title>Terms & Conditions | FinanceLoanPortal</title>
        <meta
          name="description"
          content="Read the Terms & Conditions for using FinanceLoanPortal."
        />
        <link rel="canonical" href="https://financeloanportal.com/terms" />
      </Helmet>
        ...
        <div className="container">
          <div className="static-content">
            ...
            <section className="content-section">
              ...
              <p>
                By accessing and using FinanceLoanPortal, you accept and agree
            ...
            <section className="content-section">
              ...
              <p>
                ...
                to use the website in any way that breaches any applicable
            ...
            <section className="content-section">
              ...
              <p>
                Unless otherwise stated, FinanceLoanPortal and/or its licensors
                own the intellectual property rights for all material on
                FinanceLoanPortal. All intellectual property rights are
                reserved. You may access this from FinanceLoanPortal for your
            ...
            <section className="content-section">
              ...
              <p>
                ...
                and exchange opinions and information. FinanceLoanPortal does
                not filter, edit, publish, or review Comments prior to their
                presence on the website. Comments do not reflect the views and
                opinions of FinanceLoanPortal, its agents, and/or affiliates.
              </p>
            </section>
            ...
            <section className="content-section">
              ...
              <p>
                ...
                services that are not owned or controlled by FinanceLoanPortal.
            ...
            <section className="content-section">
              ...
              <p>
                Images used on this website may be sourced from various
                providers. We respect intellectual property rights and make
                efforts to credit original sources. If you believe any content
