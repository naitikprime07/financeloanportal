...
const Privacy = () => {
  return (
    <>
      <Helmet>
        <title>Privacy Policy | FinanceLoanPortal</title>
        <meta
          name="description"
          content="Read the Privacy Policy for FinanceLoanPortal to understand how we collect, use, and protect your information."
        />
        <link rel="canonical" href="https://financeloanportal.com/privacy" />
      </Helmet>
        ...
        <div className="container">
          <div className="static-content">
            ...
            <section className="content-section">
              ...
              <p>
                FinanceLoanPortal ("we," "us," or "our") operates the website
            ...
            <section className="content-section">
              ...
              <ul>
                ...
                <li>
                  Communicate with you regarding updates, newsletters, or
                  marketing materials
                </li>
            ...
            <section className="content-section">
              ...
              <ul>
                <li>
                  <strong>With Service Providers:</strong> To facilitate our
                  services and perform service-related tasks
                </li>
                <li>
            ...
            <section className="content-section">
              ...
              <p>
                ...
                sources or display media from various providers. These
                third-party services may collect data about you, use cookies,
